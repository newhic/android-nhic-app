...
import apps4christ.android.nhicapp.fragments.SettingsFragment;
import apps4christ.android.nhicapp.slidingmenu.*;
...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Don't forget to set this to false, when we are good to release.
	 ...
	 * 
	 * Populate the Navigation Drawer with menu titles and icons. Icons and titles are
	...
	private void displayView(int position) {
		...
		case 0:
			...
			break;
		case 1:
			fragment = announceFrag;
			/** Enabling dropdown list navigation for the action bar */
	        getActionBar().setNavigationMode(ActionBar.NAVIGATION_MODE_STANDARD);
			break;
		case 2:
			fragment = podcastFrag;
			/* Disable dropdown list navigation for the action bar */
		...
		if (fragment != null) {
			...
			Log.e("MainActivity", "Error in switching to fragment");
		}
	}
