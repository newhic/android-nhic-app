...
public class ParseVideos implements Runnable {
	 ...
	 */
	public ParseVideos(Handler replyTo, String username) {
	...
	public void run() {
		try {
			...
			ArrayList<YTVid> videosList = new ArrayList<YTVid>();
			...
			for (int i = 0; i < jsonArray.length(); i++) {
				...
				// Date of the video
				uploadDate = jsonObject.getString("uploaded");
			...
			Library lib = new Library(username, videosList);
